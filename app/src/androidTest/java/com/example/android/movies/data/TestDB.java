...
public class TestDB extends AndroidTestCase {
    ...
    public void testCreateDB()
    {
        ...
        tableNameHashSet.add(MoviesContract.FavouriteEntry.TABLE_NAME);
        ...
        c = db.rawQuery("PRAGMA table_info(" + MoviesContract.FavouriteEntry.TABLE_NAME + ")",
                null);
        ...
        favouritesColumnHashSet.add(MoviesContract.FavouriteEntry._ID);
        favouritesColumnHashSet.add(MoviesContract.FavouriteEntry.NAME);
    ...
    public void testFavouritesTable()
    {
        ...
        long dbRowID = db.insert(MoviesContract.FavouriteEntry.TABLE_NAME,null,values);
